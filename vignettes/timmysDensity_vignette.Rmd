...
areaData <- mclapply(uniqAreas, summarizeArea, mc.cores = 6)
areaData <- do.call(rbind, areaData)
.sessionInfo <- sessionInfo()
.timedate <- Sys.time()
write.table(areaData, file="inst/extdata/areaData.txt", sep="\t", row.names=F, col.names=T)
save(areaData, .sessionInfo, .timedate, file="data/areaDataFile.RData", compress="xz")
```
