...
All of the necessary processed data and code is available in the `R` package [`timmysDensity`](https://github.com/rmflight/timmysDensity). You can install it using `devtools`.
